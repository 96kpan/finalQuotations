...
CREATE TABLE `quotations` (
  ...
  `flagged` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `quotations` VALUES (1,2147483647,'sadasda','a',0,'t'),(2,2147483647,'dasdsa','a',7,'t'),(3,2147483647,'YOOOOOO','Katie',21,'t');
...
-- Dump completed on 2016-11-16  9:50:44
